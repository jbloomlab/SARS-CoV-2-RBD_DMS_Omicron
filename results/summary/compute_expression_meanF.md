...
```
    ...
    ## [1] "read:cell ratio for pool1 SortSeq_bin1 is 1.24077427821522"
    ## [1] "read:cell ratio for pool1 SortSeq_bin2 is 1.9313787542537"
    ## [1] "read:cell ratio for pool1 SortSeq_bin3 is 2.64600351229227"
    ## [1] "read:cell ratio for pool1 SortSeq_bin4 is 2.80320767004938"
    ## [1] "read:cell ratio for pool2 SortSeq_bin1 is 1.4030729399436"
    ## [1] "read:cell ratio for pool2 SortSeq_bin2 is 1.95280645534154"
    ## [1] "read:cell ratio for pool2 SortSeq_bin3 is 2.53231427152331"
    ## [1] "read:cell ratio for pool2 SortSeq_bin4 is 2.59965484304126"
...
invisible(dt[library=="pool1",c("expression","ML_sdF") := tryCatch(calc.MLmean(b1=SortSeq_bin1*20,b2=SortSeq_bin2*20,
                                                                      ...
                                                                      min.b1=log(20),min.b2=log(603.5),min.b3=log(4909.5),
                                                                      min.b4=log(12576.5),max.b4=log(229000)),
...
We have generated expression measurements for 83.65% of the barcodes in
our libraries.
