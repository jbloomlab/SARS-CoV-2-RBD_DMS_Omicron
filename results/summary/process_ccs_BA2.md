...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>BA2</td>
      <td>220524_B</td>
      <td>pool1_BA2_220524_B</td>
      <td>results/ccs/pool1_BA2_220524_B_ccs.fastq.gz</td>
    </tr>
    <tr>
      <td>pool2</td>
      <td>BA2</td>
      <td>220524_B</td>
      <td>pool2_BA2_220524_B</td>
      <td>results/ccs/pool2_BA2_220524_B_ccs.fastq.gz</td>
    </tr>
  </tbody>
</table>
...
```
    ...
    Reading amplicons from data/PacBio_amplicon_BA2.gb
    Reading feature parse specs from data/feature_parse_specs_BA2.yaml
...
```
    ...
    Saving plot to results/process_ccs/amplicons_BA2.pdf



    
![png](process_ccs_BA2_files/process_ccs_BA2_22_1.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_32_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_34_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_36_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_38_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_42_0.png)
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <td>pool1</td>
      <td>m64272e_220526_094844/0/ccs</td>
      <td>G350T C351T</td>
      <td>0.99934</td>
      <td>ACTCATCAGCTGCAGT</td>
      <td>1.0</td>
      <td>BA2</td>
    </tr>
    <tr>
      <td>pool1</td>
      <td>m64272e_220526_094844/9/ccs</td>
      <td>T181G G182T</td>
      <td>1.00000</td>
      <td>ACTATGCAACAAGTTC</td>
      <td>1.0</td>
      <td>BA2</td>
    </tr>
    <tr>
      <td>pool1</td>
      <td>m64272e_220526_094844/10/ccs</td>
      <td>T22G T23A C24T</td>
      <td>1.00000</td>
      <td>CCTGCTTACCCTCCCA</td>
      <td>1.0</td>
      <td>BA2</td>
    </tr>
    <tr>
      <td>pool1</td>
      <td>m64272e_220526_094844/20/ccs</td>
      <td>A79G G80A A81T</td>
      <td>1.00000</td>
      <td>TTCTAGAATTAGCTTA</td>
      <td>1.0</td>
      <td>BA2</td>
    </tr>
    <tr>
      <td>pool1</td>
      <td>m64272e_220526_094844/37/ccs</td>
      <td>T332C G333T</td>
      <td>1.00000</td>
      <td>AGTGGTATGATAATAC</td>
      <td>1.0</td>
      <td>BA2</td>
    </tr>
  </tbody>
...
```
    ...
    Barcodes and mutations for valid processed CCSs have been written to results/process_ccs/processed_ccs_BA2.csv.
...
```
    ...
    Read 2080238 CCSs from 2 libraries and 1 targets.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th rowspan="2" valign="top">BA2</th>
      <th>pool1</th>
      <td>1034928</td>
      <td>129366</td>
      <td>8.00</td>
...
![png](process_ccs_BA2_files/process_ccs_BA2_59_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_63_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_65_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_69_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_75_1.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_84_0.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_86_1.png)
...
```
    ...
    Writing nucleotide variants to results/variants/nucleotide_variant_table_BA2.csv
...
![png](process_ccs_BA2_files/process_ccs_BA2_92_0.png)
...
```
    ...
    Read gene of 603 nts for BA2 from data/PacBio_amplicon_BA2.gb
...
![png](process_ccs_BA2_files/process_ccs_BA2_100_0.png)
...
```
    ...
    Saving plot to results/figures/n_aa_muts_per_variant_BA2.pdf
    Saving plot to results/figures/n_codon_muts_per_variant_BA2.pdf



    
![png](process_ccs_BA2_files/process_ccs_BA2_102_1.png)
    



    
![png](process_ccs_BA2_files/process_ccs_BA2_102_2.png)
...
```
    ...
    Saving plot to results/figures/avg_muts_per_variant_BA2.pdf



    
![png](process_ccs_BA2_files/process_ccs_BA2_104_1.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_106_0.png)
...
```
    ...
    Saving plot to results/figures/variant_cumul_all_mut_coverage_BA2.pdf
    Saving plot to results/figures/variant_cumul_single_mut_coverage_BA2.pdf



    
![png](process_ccs_BA2_files/process_ccs_BA2_108_1.png)
    



    
![png](process_ccs_BA2_files/process_ccs_BA2_108_2.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_112_0.png)
    



    
![png](process_ccs_BA2_files/process_ccs_BA2_112_1.png)
...
![png](process_ccs_BA2_files/process_ccs_BA2_114_0.png)
    



    
![png](process_ccs_BA2_files/process_ccs_BA2_114_1.png)
...
```
    ...
    Writing codon-variant table to results/variants/codon_variant_table_BA2.csv
